...
from phineas.model import call_llm, call_llm_stream
from phineas.prompts import (
...
from phineas.schemas import Answer, IsDone, OptimizedToolArgs, Task, TaskList
from phineas.tools import TOOLS
from phineas.utils.logger import Logger
from phineas.utils.ui import show_progress
from phineas.utils.context import ContextManager
...
class Agent:
    ...
    def optimize_tool_args(self, tool_name: str, initial_args: dict, task_desc: str) -> dict:
        ...
        """
        try:
            response = call_llm(prompt, model="claude-sonnet-4-20250514", system_prompt=get_tool_args_system_prompt(), output_schema=OptimizedToolArgs)
