...
from phineas.evals.dataset import create_dataset_from_csv
from phineas.evals.evaluator import run_evaluation, eval_correctness
...
def main():
    ...
    return run_evaluation(
        ...
        experiment_prefix="Phineas Finance Agent Eval",
        max_concurrency=5,
        metadata={
