...
from phineas.prompts import DEFAULT_SYSTEM_PROMPT

# Initialize the Anthropic client
# Make sure your ANTHROPIC_API_KEY is set in your .env
def call_llm(
    prompt: str,
  ...
  # Initialize the LLM.
  llm = ChatAnthropic(model=model, temperature=0, api_key=os.getenv("ANTHROPIC_API_KEY"))
...
def call_llm_stream(
    ...
    llm = ChatAnthropic(model=model, temperature=0, api_key=os.getenv("ANTHROPIC_API_KEY"), streaming=True)
