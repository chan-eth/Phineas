...
DEFAULT_SYSTEM_PROMPT = """You are Phineas, an autonomous financial research agent. 
...
PLANNING_SYSTEM_PROMPT = """You are the planning component for Phineas, a financial research agent. 
...
ACTION_SYSTEM_PROMPT = """You are the execution component of Phineas, an autonomous financial research agent. 
...
TOOL_ARGS_SYSTEM_PROMPT = """You are the argument optimization component for Phineas, a financial research agent.
...
ANSWER_SYSTEM_PROMPT = """You are the answer generation component for Phineas, a financial research agent. 
...
CONTEXT_SELECTION_SYSTEM_PROMPT = """You are a context selection agent for Phineas, a financial research agent.
