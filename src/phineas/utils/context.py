...
from phineas.model import call_llm
from phineas.prompts import DEFAULT_SYSTEM_PROMPT, CONTEXT_SELECTION_SYSTEM_PROMPT


class ContextManager:
    """Manages context offloading and onloading for tool outputs."""
    
    def __init__(self, context_dir: str = ".phineas/context"):
        """
    ...
    def select_relevant_contexts(
        ...
        from phineas.schemas import SelectedContexts
